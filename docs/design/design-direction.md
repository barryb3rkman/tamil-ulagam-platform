...
The Contact page is a text-led institutional routing guide rather than a form or support interface. A restrained geometric hero, numbered enquiry paths, firm information boundaries and a prominent emergency limitation explain how future conversations may be prepared without publishing contact details or implying live processing. Contact remains available through the approved footer information architecture instead of crowding the primary navigation.

The Privacy Policy and Terms of Use pages form a shared draft legal-policy system. Deep navy document headers, a prominent maroon review notice, gold section numbering and restrained ivory reading surfaces create an authoritative hierarchy without resembling government certification or a final signed contract. Desktop pages use a sticky table of contents beside a comfortable reading column; the same navigation returns to normal document flow on smaller screens. Decision panels, operational triggers and launch checklists make unresolved work visible rather than implying approval.
