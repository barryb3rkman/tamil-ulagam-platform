...
export function RoadmapHero() {
  ...
  return (
    ...
    >
      <div className="grid min-h-[min(840px,calc(100svh-5rem))] lg:grid-cols-[0.76fr_1.24fr]">
        ...
        <div className="bg-global-navy relative flex min-h-[340px] items-center justify-center overflow-hidden px-5 py-10 sm:min-h-[460px] sm:px-8 lg:min-h-0 lg:px-10">
          ...
          <div className="relative w-full max-w-5xl overflow-hidden">
            <ImageWithFallback
              ...
              fallbackLabel="Roadmap future concept representation"
              priority
