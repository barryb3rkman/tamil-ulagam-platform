...
export function TamilIdFaq() {
  return (
    <Section tone="ivory" aria-labelledby="tamil-id-faq-title">
      <Container
        size="wide"
...
export function TamilIdFinalCta() {
  const { finalCallToAction } = tamilIdContent;

  return (
    <Section
      tone="navy"
      spacing="generous"
      aria-labelledby="tamil-id-final-cta-title"
