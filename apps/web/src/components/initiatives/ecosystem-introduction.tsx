        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)] lg:gap-20">
          <div>
            ...
            <h2
              ...
              className="text-fg mt-5 max-w-xl text-4xl leading-[1.06] font-semibold tracking-[-0.04em] text-balance sm:text-5xl"
            >
              {introduction.title}
            </h2>
          </div>
          <div className="border-hairline/12 lg:border-l lg:pl-12">
            <p className="text-fg-muted max-w-2xl text-lg leading-8">
