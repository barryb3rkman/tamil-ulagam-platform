    ...
    <Section tone="ivory" aria-labelledby="knowledge-culture-title">
      <Container size="wide">
        <div className="max-w-4xl">
          ...
          <p className="text-fg-muted mt-5 max-w-3xl text-lg leading-8">
            {knowledgeCultureGlobal.description}
          </p>
        </div>
        <article className="border-hairline/12 bg-raised mt-9 grid overflow-hidden border lg:grid-cols-[minmax(0,1.16fr)_minmax(0,0.84fr)]">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          {supportingInitiatives.map((initiative) => {
            ...
            return (
              <article
                key={initiative.slug}
                className="border-hairline/12 bg-raised overflow-hidden border"
              >
                ...
                <div className="p-5 sm:p-6">
                  <h3 className="text-fg text-2xl font-semibold tracking-[-0.025em]">
                    {initiative.title}
                  </h3>
