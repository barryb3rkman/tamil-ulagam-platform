    ...
    <Section tone="white" aria-labelledby="readiness-principles-title">
      <Container size="wide">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] lg:gap-20">
          <div>
            <p className="text-fg-accent text-eyebrow">{readiness.eyebrow}</p>
            <h2
              id="readiness-principles-title"
              className="text-fg mt-5 text-4xl leading-[1.06] font-semibold tracking-[-0.04em] text-balance sm:text-5xl"
            >
              {readiness.title}
            </h2>
