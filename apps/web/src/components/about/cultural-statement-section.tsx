      ...
      <Container size="narrow" className="text-center">
        ...
        <blockquote className="mt-10">
          <h2
            ...
            lang="ta"
            className="font-tamil text-fg text-4xl leading-[1.45] font-semibold tracking-[-0.025em] sm:text-5xl lg:text-6xl"
          >
            {culturalStatement.tamil}
          </h2>
          <p className="text-fg-accent mt-7 text-xl leading-8 font-medium sm:text-2xl">
            {culturalStatement.translation}
          </p>
          <footer className="text-fg-muted text-eyebrow mt-5">
            {culturalStatement.attribution}
          </footer>
        </blockquote>
        <p className="text-fg-muted mx-auto mt-9 max-w-xl leading-7">
