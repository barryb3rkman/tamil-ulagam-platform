    ...
    <Section tone="ivory" aria-labelledby="stories-title">
      <Container size="wide">
        <div className="grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:gap-20">
          ...
          <div>
            <p className="text-fg-accent text-eyebrow">COMMUNITY STORIES</p>
            <h2
              id="stories-title"
              className="text-fg mt-4 max-w-xl text-4xl leading-[1.08] font-semibold tracking-[-0.035em] sm:text-5xl"
            >
