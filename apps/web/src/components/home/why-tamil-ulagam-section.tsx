      ...
      <Container>
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.06fr)_minmax(0,0.94fr)] lg:gap-20">
          ...
          <div className="lg:order-1">
            <p className="text-fg-accent text-eyebrow">WHY TAMIL ULAGAM</p>
            <h2
              id="why-title"
              className="text-fg mt-4 max-w-xl text-4xl leading-[1.08] font-semibold tracking-[-0.035em] text-balance sm:text-5xl"
            >
              {homepageContent.why.title}
            </h2>
            <p className="text-fg-muted mt-6 max-w-xl text-lg leading-8">
