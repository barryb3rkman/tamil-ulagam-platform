...
exec pnpm --filter @tamil-ulagam/web exec playwright test --workers=1 tests/e2e/supabase-local.spec.ts tests/e2e/member-affiliation-lifecycle.spec.ts tests/e2e/sangam-registration-lifecycle.spec.ts tests/e2e/organisation-registration-lifecycle.spec.ts
