...
exec pnpm --filter @tamil-ulagam/web exec vitest run src/lib/supabase/local-integration.test.ts src/lib/supabase/local-integration-membership.test.ts src/lib/supabase/local-integration-sangam.test.ts src/lib/supabase/local-integration-admin-operations.test.ts src/lib/supabase/local-integration-management.test.ts src/lib/supabase/local-integration-email.test.ts
